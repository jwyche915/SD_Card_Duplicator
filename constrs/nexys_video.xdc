...
##   sd_dat3  → SPI CS_N
## ----------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { src_sd_sclk }]; #IO_L12P_T1_MRCC_14 Sch=sd_cclk
set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { src_sd_mosi }]; #IO_L12N_T1_MRCC_14 Sch=sd_cmd
set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { src_sd_miso }]; #IO_L14N_T2_SRCC_14 Sch=sd_d[0]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { src_sd_cs_n }]; #IO_L18N_T2_A11_D27_14 Sch=sd_d[3]
...
set_property PULLUP TRUE [get_ports { src_sd_reset_n }];
...
##   JA Pin 4 (AB18) → MISO
## ----------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { dst_sd_cs_n }];  #IO_L10N_T1_D15_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { dst_sd_sclk }];  #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { dst_sd_mosi }];  #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { dst_sd_miso }];  #IO_L17N_T2_A13_D29_14 Sch=ja[4]
## Pull-up on MISO: SD card tri-states this line when CS is high
set_property PULLUP TRUE [get_ports { dst_sd_miso }];
set_property PULLUP TRUE [get_ports { dst_sd_mosi }];
